...
<title>The Maltese Falcon | Zoom.lk</title>
		...
		<div class="row">
			<div class="col-md-3 justify-content-center">
				<p style="text-align: center;">
					<img class="img-fluid" src="pix/Jaya1.jpg" width="250px"><br>
					<br> <a class="btn btn-primary w-75" href="#">Download</a>
				</p>
			</div>
			<div class="col-md-9">
				<h1 class="display-4" style="color: black;">The Maltese Falcon
					Subtitles</h1>
				<h4 class="display-8 text-primary">Action, Family, Fantasy</h4>
				<div class="row ">
					<div class="col-md-5 ">
						<p>
							<br>In this noir classic, detective Sam Spade (Humphrey
							Bogart) gets more than he bargained for when he takes a case
							brought to him by a beautiful but secretive woman (Mary Astor).
							As soon as Miss Wonderly shows up, trouble follows as Sam's
							partner is murdered and Sam is accosted by a man (Peter Lorre)
							demanding he locate a valuable statuette. Sam, entangled in a
							dangerous web of crime and intrigue, soon realizes he must find
							the one thing they all seem to want: the bejeweled Maltese
							falcon.
						</p>
						<br> <br>
					</div>
					<div class="col-md-5 ">
						...
						<iframe width="560" height="315"
							src="https://www.youtube.com/embed/3a9YU1SVbSE" frameborder="0"
				...
				<ul class="list-group list-group-flush">
					<li class="list-group-item">
						<div class="row">
							...
							Christopher Nolan
							<div class="col-md-7 text-right">John Huston (screen play
								by), Dashiell Hammett (based upon the novel by)</div>
						</div>
					</li>
					<li class="list-group-item">
						<div class="row">
							<div class="col-md-5 text-secondary">DIRECTOR</div>
							<div class="col-md-7 text-right">John Huston</div>
						</div>
					</li>
					<li class="list-group-item">
						<div class="row">
