	...
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
				...
				<div class="col-sm-3">
					<div class="card h-100" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<p class="card-text">
								A kind-hearted street urchin and a power-hungry Grand Vizier vie
								for a magic lamp that has the power to make their deepest wishes
								come true...<a href="Mov_Aladdin.jsp">Read More</a>
							</p>
							<a href="ZipFiles/test_file.zip" download class="btn btn-primary">Download</a>
							&nbsp; &nbsp; &nbsp; <a
					...
					<div class="card h-100" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<p class="card-text">
								...
								save her parents and solve the mystery...<a href="Mov_Dora.jsp">Read
									More</a>
							</p>
							<a href="ZipFiles/test_file.zip" download class="btn btn-primary">Download</a>
							&nbsp; &nbsp; &nbsp; <a
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="card h-100" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<a s class="btn btn-primary">Download</a> &nbsp; &nbsp;
				...
				<div class="col-sm-3">
					<div class="card h-100" style="width: 16rem;">
						<img class="card-img-top" src="pix/spider.jpg" alt="Movie Poster">
						<div class="card-body">
							<h5 class="card-title">
