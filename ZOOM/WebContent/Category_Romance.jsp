						...
						<ul class="dropdown-menu">
							...
							<li class="dropdown-submenu dropright"><a
								...
								<ul class="dropdown-menu">
									...
									<li><a class="btn" href="Category_Romance.jsp" style="background-color: #c0c0c0; width: 100%; border-radius: 0px;">Romance</a></li>
...
<div class="container">
  ...
  <p>No need to register to download Subtitles:</p>            
				...
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<p class="card-text">On a routine journey through space to a new home, two passengers, sleeping in suspended animation, are awakened 90 years too early when their ship malfunctions. As Jim and Aurora...</p>
							</div> <br>
				...
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text">Tessa Young is a dedicated student, dutiful daughter and loyal girlfriend to her high school sweetheart. Entering her first semester of college, Tessa's guarded world opens up when she meets Hardin...</p>
							</div> <br>
							<a href="#" class="btn btn-primary">Download</a> &nbsp; &nbsp;
							&nbsp; <a
								href="https://www.imdb.com/title/tt4126476/"
								class="btn btn-warning">IMDB link</a>
						</div>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text">Sam is a disenchanted 33-year-old who discovers a mysterious woman, Sarah, frolicking in his apartment's swimming pool. When she vanishes, Sam embarks on a surreal quest across Los Angeles to decode...</p>
							</div> <br>
				...
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text">Aladdin is a lovable street urchin who meets Princess Jasmine, the beautiful daughter of the sultan of Agrabah. While visiting her exotic palace, Aladdin stumbles upon a magic oil lamp that unleashes...</p>
							</div> <br>
							<a href="Mov_DarkPhoenix.jsp" class="btn btn-primary">Download</a>
							&nbsp; &nbsp; &nbsp; <a
				...
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text">Childhood sweethearts have a falling out and don't speak for 15 years, only reconnecting as adults when Sasha runs into Marcus in San Francisco. Although the old sparks are still there, the couple ... </p>
							</div> <br>
							<a href="#" class="btn btn-primary">Download</a> &nbsp; &nbsp;
				...
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text"> A young woman, who has been continuously unlucky, accepts a job as a department store elf during the holidays. When Kate meets Tom on the job, her life takes a turn. The lady thinks to be like .......</p>
							</div> <br>
							<a href="#" class="btn btn-primary">Download</a> &nbsp; &nbsp;
				...
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text">When city girl Gabriela spontaneously enters a contest and wins a rustic New Zealand inn, she teams up with bighearted contractor Jake Taylor to fix and flip it contest and wins a rustic New Zealand ..</p>
							</div> <br>
							<a href="#" class="btn btn-primary">Download</a> &nbsp; &nbsp;
				...
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text">Dumped by her long-term boyfriend, a music journalist recruits her two best friends for one last outrageous adventure in New York City before she moves to San Francisco. After having so many breakups..</p>
							</div> <br>
							<a href="#" class="btn btn-primary">Download</a> &nbsp; &nbsp;
							&nbsp; <a
								href="https://www.imdb.com/title/tt2442560/"
								class="btn btn-warning">IMDB link</a>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text"> Jack Malik is a struggling singer or songwriter in an English seaside town whose dreams of fame are rapidly fading,  despite the fierce devotion and support of his childhood best A struggling musician realizes he's the only....</p>
							</div> <br>
							<a href="#" class="btn btn-primary">Download</a> &nbsp; &nbsp;
							&nbsp; <a
								href="https://www.imdb.com/title/tt8079248/"
								class="btn btn-warning">IMDB link</a>
						</div>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text">Journalist Fred Flarsky reunites with his childhood crush, Charlotte Field, now one of the most influential women in the world. As she prepares to make a run for the Presidency, Charlotte hires Fred as her speechwriter and sparks..</p>
							</div> <br>
							<a href="#" class="btn btn-primary">Download</a> &nbsp; &nbsp;
							&nbsp; <a
								href="https://www.imdb.com/title/tt2139881/"
								class="btn btn-warning">IMDB link</a>
						</div>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text">In 1946 Rachael Morgan arrives in the ruins of Hamburg to be reunited with her husband, Lewis, who is a British colonel charged with rebuilding the shattered city. As they set off for their new home, Rachael is stunned to discover </p>
							</div> <br>
							<a href="#" class="btn btn-primary">Download</a> &nbsp; &nbsp;
							&nbsp; <a
								href="https://www.imdb.com/title/tt5977276/"
								class="btn btn-warning">IMDB link</a>
						</div>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="card" style="width: 16rem;">
						...
						<div class="card-body">
							...
							<div class="text-justify">
							<p class="card-text">Natalie is a New York architect who works hard to get noticed at her job, but is more likely to deliver coffee and bagels than design the city's next skyscraper. Things go from bad to weird when ...</p>
							</div> <br>
							<a href="#" class="btn btn-primary">Download</a> &nbsp; &nbsp;
							&nbsp; <a
								href="https://www.imdb.com/title/tt2452244/"
								class="btn btn-warning">IMDB link</a>
						</div>
					</div>
				</div>
